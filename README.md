...
**The `wdk-cli` seam.** `cerrojo paridad` is where Tether's own CLI is wired in, and where it is held to the
engine's decisions.

<!-- The rows below are pinned to fba241bd54ef7d2cfeccb82c95e4a86d836be371; all nine line ranges were verified against the file contents at that SHA. -->
